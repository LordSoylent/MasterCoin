...
private slots:
    ...
    QString BuyMasterCoin(QString OrderType, double Quantity, double Rate);
    QString SellMasterCoin(QString OrderType, double Quantity, double Rate);
